...
//!
//! Workspace management (cloning a project's repo per card), the live session UI over
//! WebSocket, Atlas's own MCP server, and card→task binding are later work in this phase —
//! see `docs/research/claude-code-cli.md` for the exact CLI behaviour this module encodes,
//! most importantly its two documented traps: `subtype: "success"` staying put on API/auth
